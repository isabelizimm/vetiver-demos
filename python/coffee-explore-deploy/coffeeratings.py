...
from vetiver import VetiverModel, VetiverAPI, vetiver_endpoint, server
...
coffee = VetiverModel(lr, model_name = "coffee", save_ptype = True, ptype_data=X_train, \
                    description="a linear regression for coffee points")
...
# response = server.predict(data, endpoint)
